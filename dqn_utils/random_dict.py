"""RandomDict data structure from https://github.com/robtandy/randomdict,
with additional bug fix from https://github.com/robtandy/randomdict/pull/3/files.
Allows items to be sampled randomly from a dictionary in O(1) time.
"""
